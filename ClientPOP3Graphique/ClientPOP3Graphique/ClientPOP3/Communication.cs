    ...
    public static class Communication
    {
        ...
        public static void List()
        {
            ...
            else
            {
                ...
                {
                    string[] lesValeurs = ligne.Split(' ');
                    int tb = Int32.Parse(lesValeurs[1]);
                    clientPOP3.WriteAffichage("  " + tb.ToString());
                    ligne = LireLigne();
                }
            }
        }
        public static void Retr(decimal Value, int nbLignes)
        {
            //// *** BLOC A DECOMMENTER  : Ctrl+e puis u  ***
            string ligne, tampon;
            tampon = "RETR " + " " + Value ;
        ...
        public static void Entete(decimal Value, int nbLignes)
        {
            //// *** BLOC A DECOMMENTER  : Ctrl+e puis u  ***
            string ligne, tampon ;
            tampon = "TOP" + " " + Value + " " + nbLignes; 
            EcrireLigne(tampon);
            ///* réception de +OK .... */
            ligne = LireLigne();
            if (!ligne[0].Equals('+'))
